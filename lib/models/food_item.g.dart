...
void _foodItemSerialize(
  ...
  writer.writeLong(offsets[8], object.proteins);
  writer.writeString(offsets[9], object.quantity);
  writer.writeLong(offsets[10], object.totQuantity);
}
...
FoodItem _foodItemDeserialize(
  ...
  final object = FoodItem(
    ...
    proteins: reader.readLong(offsets[8]),
    quantity: reader.readString(offsets[9]),
    totQuantity: reader.readLongOrNull(offsets[10]) ?? 0,
  );
  object.id = id;
  return object;
}
...
FoodItem _$FoodItemFromJson(Map<String, dynamic> json) => FoodItem(
      ...
      totQuantity: json['totQuantity'] as int? ?? 0,
